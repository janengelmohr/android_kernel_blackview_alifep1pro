...
//2015-5-4,[lijian]bug id:none add for charging ic cw2015,start
#if defined(CONFIG_RGK_DRIVER_FG_CW2015)
#include <mach/cw2015_battery.h>
int FG_charging_status =0;
#endif
//2015-5-4,[lijian]bug id:none add for charging ic cw2015,end

//2015-5-4,[lijian]bug id:none add for wirless charge wpc,start
#if defined(CONFIG_RGK_DRIVER_WIRELESS_CHARGER)
#include <mach/mt_gpio.h> 
#ifdef CONFIG_RGK_DRIVER_WIRELESS_CHARGER_GIPO
int rgk_wireless_charger_gpio_number   = (CONFIG_RGK_DRIVER_WIRELESS_CHARGER_GIPO | 0x80000000); 
#else
int rgk_wireless_charger_gpio_number   = (3 | 0x80000000); 
#endif
#endif 
//2015-5-4,[lijian]bug id:none add for wirless charge wpc,end
...
//2015-5-4,[lijian]bug id:none add for wirless charge wpc,start
        ...
        {
					mt_set_gpio_mode(rgk_wireless_charger_gpio_number,0);
					mt_set_gpio_dir(rgk_wireless_charger_gpio_number,1);
					mt_set_gpio_out(rgk_wireless_charger_gpio_number,1);
        }
#endif
//2015-5-4,[lijian]bug id:none add for wirless charge wpc,end
...
//2015-5-4,[lijian]bug id:none add for wirless charge wpc,start
        ...
        if(BMT_status.charger_type !=  WIRELESS_CHARGER)
        {
					mt_set_gpio_mode(rgk_wireless_charger_gpio_number,0);
					mt_set_gpio_dir(rgk_wireless_charger_gpio_number,1);
					mt_set_gpio_out(rgk_wireless_charger_gpio_number,0);
        }
#endif        
//2015-5-4,[lijian]bug id:none add for wirless charge wpc,end
